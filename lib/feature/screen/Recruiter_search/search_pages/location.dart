...
import 'package:crowdv_mobile_app/data/models/recruiter/Volunteer_location.dart';
...
class Location extends StatefulWidget {
  final dynamic token, location;
  Location({this.token, this.location});
  @override
  _HistoryState createState() => _HistoryState();
}

class _HistoryState extends State<Location> {
  Future<LocationVolunteer> getCateVolunteerApi() async {
    ...
    if (response.statusCode == 200) {
      return LocationVolunteer.fromJson(data);
    } else {
      return LocationVolunteer.fromJson(data);
    }
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Expanded(
                child: FutureBuilder<LocationVolunteer>(
