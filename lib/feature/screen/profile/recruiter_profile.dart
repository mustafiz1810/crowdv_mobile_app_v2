...
import 'package:crowdv_mobile_app/data/models/recruiter/profile_model.dart';
...
class _RecruiterProfileState extends State<RecruiterProfile> {
  ...
  Future<RecruiterProfileModel> getProfileApi() async {
    ...
    if (response.statusCode == 200) {
      return RecruiterProfileModel.fromJson(data);
    } else {
      return RecruiterProfileModel.fromJson(data);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
              child: FutureBuilder<RecruiterProfileModel>(
