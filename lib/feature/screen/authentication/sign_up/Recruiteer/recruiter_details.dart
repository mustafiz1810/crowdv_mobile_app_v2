...
class RecruiterDetails extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _RecruiterDetailsState();
  }
}

class _RecruiterDetailsState extends State<RecruiterDetails> {
  ...
  List<String> _type = ["Individual", "Organization"];
  List<String> _dtype = ["ADD or ADHD", "Blindness or Vision Impairment"];
  ...
  void signup(String fname, lname, email, phone, state, city, apt, street, zip,
    ...
    try {
      Response response =
          await post(Uri.parse(NetworkConstants.BASE_URL + 'recruiter'), body: {
        'first_name': fname,
        'last_name': lname,
        'sur_name': lname,
        'email': email,
