...
//
//     final locationWiseTask = locationWiseTaskFromJson(jsonString);

import 'dart:convert';

LocationWiseTask locationWiseTaskFromJson(String str) => LocationWiseTask.fromJson(json.decode(str));

String locationWiseTaskToJson(LocationWiseTask data) => json.encode(data.toJson());

class LocationWiseTask {
  LocationWiseTask({
    this.success,
    this.message,
    this.data,
  ...
  factory LocationWiseTask.fromJson(Map<String, dynamic> json) => LocationWiseTask(
