...
//
//     final individualWiseTask = individualWiseTaskFromJson(jsonString);

import 'dart:convert';

IndividualWiseTask individualWiseTaskFromJson(String str) => IndividualWiseTask.fromJson(json.decode(str));

String individualWiseTaskToJson(IndividualWiseTask data) => json.encode(data.toJson());

class IndividualWiseTask {
  IndividualWiseTask({
    this.success,
    this.message,
    this.data,
  ...
  factory IndividualWiseTask.fromJson(Map<String, dynamic> json) => IndividualWiseTask(
